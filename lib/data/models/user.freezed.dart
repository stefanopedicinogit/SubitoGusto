...
class _$AppUserImpl extends _AppUser {
  ...
  @override
  String toString() {
    return 'AppUser(id: $id, tenantId: $tenantId, email: $email, role: $role, firstName: $firstName, lastName: $lastName, avatarUrl: $avatarUrl, isActive: $isActive, createdAt: $createdAt, updatedAt: $updatedAt, lastLoginAt: $lastLoginAt)';
  }
