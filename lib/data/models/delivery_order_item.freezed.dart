...
abstract class $DeliveryOrderItemCopyWith<$Res> {
  factory $DeliveryOrderItemCopyWith(
    DeliveryOrderItem value,
    $Res Function(DeliveryOrderItem) then,
...
abstract class _$$DeliveryOrderItemImplCopyWith<$Res>
    implements $DeliveryOrderItemCopyWith<$Res> {
  factory _$$DeliveryOrderItemImplCopyWith(
    _$DeliveryOrderItemImpl value,
...
class __$$DeliveryOrderItemImplCopyWithImpl<$Res>
  ...
  __$$DeliveryOrderItemImplCopyWithImpl(
    _$DeliveryOrderItemImpl _value,
...
/// @nodoc
@JsonSerializable()
class _$DeliveryOrderItemImpl extends _DeliveryOrderItem {
  ...
  @override
  String toString() {
    return 'DeliveryOrderItem(id: $id, deliveryOrderId: $deliveryOrderId, menuItemId: $menuItemId, menuItemName: $menuItemName, unitPrice: $unitPrice, quantity: $quantity, notes: $notes, status: $status, fixedMenuId: $fixedMenuId, fixedMenuSelections: $fixedMenuSelections, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
  ...
  Map<String, dynamic> toJson() {
    return _$$DeliveryOrderItemImplToJson(this);
  }
}

abstract class _DeliveryOrderItem extends DeliveryOrderItem {
  ...
  const _DeliveryOrderItem._() : super._();
