...
/// Consumer login page for mobile (single-column, centered).
class ConsumerLoginPageMobile extends ConsumerStatefulWidget {
  const ConsumerLoginPageMobile({super.key});

  @override
  ConsumerState<ConsumerLoginPageMobile> createState() =>
      _ConsumerLoginPageMobileState();
}

class _ConsumerLoginPageMobileState
    extends ConsumerState<ConsumerLoginPageMobile> {
